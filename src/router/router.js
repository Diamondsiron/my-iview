...
export const appRouter = [
  ...
  },
  {
    ...
    component: Mains,
    children: [
        { path: 'insertmenu', meta:{title:'新增菜单'},title: '新增', name: 'insertmenu', icon: 'compose', component: () => import('@/views/menu/parent/insert.vue') },
  ...
  },
  {
    ...
    component: Mains,
    children: [
        { path: 'insertrole', meta:{title:'新增角色'},title: '新增', name: 'insertrole', icon: 'compose', component: () => import('@/views/authority/role/insert.vue') },
